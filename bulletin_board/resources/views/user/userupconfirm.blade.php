    ...
    <div class="row justify-content-center">
        <div class="col-lg-7 col-sm-11">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="post" action="/updated_user" enctype="multipart/form-data">
                        @csrf 
                        <div class="clearfix">
                        ...
                        <div class="form-group row">
                        <button type="submit" class="btn btn-primary col-sm-2" style="margin-left:10px;">Update</button><br>
                        <a href="userupdate" class="btn btn-outline-primary col-sm-2" style="margin-left:10px;" id="reset">Cancel</a>
                        </div>
                    </form>
                </div>
            </div>
